...
<template>
    <section>
        <header>
            ...
            <p class="mt-1 text-sm text-gray-600">Обновите данные профиля и email.</p>
        </header>
